...
<ul className='list list-inline ml-auto'>
    <li className='list-inline-item' >
      ...
      <Link to="/"><Button style={{color:"#2bbef9"}}>Home</Button></Link>  
    </li>
...
subcat?.length!==0 && subcat?.map((item,index)=>{
  return(
    ...
    <div className="submenu shadow d-flex " style={{flexDirection:"column"}}>
       <Link to="/"><Button>Clothing</Button></Link>   
      <Link to="/"><Button>Footwear</Button></Link>   
      <Link to="/"><Button>Watches</Button></Link>   
      <Link to="/"><Button>Footwear</Button></Link>   
    ...
    <li className='list-inline-item'>
    <Link><Button>Bakery</Button></Link>  
    <div className="submenu shadow d-flex " style={{flexDirection:"column"}}>
       <Link to="/"><Button>Clothing</Button></Link>   
      <Link to="/"><Button>Footwear</Button></Link>   
      <Link to="/"><Button>Watches</Button></Link>   
    ...
    <li className='list-inline-item'>
    <Link><Button>Fashion</Button></Link>  
    <div className="submenu shadow d-flex " style={{flexDirection:"column"}}>
       <Link to="/"><Button>Clothing</Button></Link>   
      <Link to="/"><Button>Footwear</Button></Link>   
      <Link to="/"><Button>Watches</Button></Link>   
    ...
    <li className='list-inline-item'>
    <Link><Button>Electircal</Button></Link> 
    <div className="submenu shadow d-flex " style={{flexDirection:"column"}}>
       <Link to="/"><Button>Clothing</Button></Link>   
      <Link to="/"><Button>Footwear</Button></Link>   
      <Link to="/"><Button>Watches</Button></Link>   
